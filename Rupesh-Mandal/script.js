...
inputarea.addEventListener("input", () => {
  ...
  details[3].textContent=accuracy ;
...
function displayquotes() {
  ...
  // document.getElementsByClassName("main").innerHTML = '<img src="'+images[p]+'" />';  
